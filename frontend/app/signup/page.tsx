  ...
  async function handleSignup(event: React.FormEvent) {
    ...
    try {
      ...
      if (response.status === 201) {
        ...
        setError({
          message: response.data.msg || "Signup failed. Please try again.",
        });
      }
    } catch (error: any) {
      ...
      if (error.response) {
        if (error.response.status === 400) {
          setError({
            message: error.response.data?.msg || "Invalid signup input.",
          });
        } else if (
          ...
          <div className="space-y-8 mt-12">
            <div className="flex items-start space-x-4 animate-float">
              ...
              <div>
                ...
                <p className="text-zinc-300/80">
                  Create beautiful diagrams and sketches with our easy-to-use
                  tools
                </p>
              </div>
            </div>
            ...
            <div
              ...
              <div>
                ...
                <p className="text-zinc-300/80">
                  Experience real-time coding, voice communication, and an
                  interactive chat—all in one place.
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="relative bg-zinc-900/90 backdrop-blur-xl p-8 rounded-2xl shadow-2xl border border-white/10">
              <div className="text-center mb-8">
                ...
                <p className="mt-2 text-sm text-zinc-300/80">
                  Join community of creators and teams
                </p>
              </div>
